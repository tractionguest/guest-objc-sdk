...
------------- | ------------- | -------------
[**createRegistrationSignin**](TGSigninsApi.md#createregistrationsignin) | **POST** /registrations/{registration_id}/signins | 
[**createRegistrationSignout**](TGSigninsApi.md#createregistrationsignout) | **POST** /registrations/{registration_id}/signouts | 
...
[apiInstance createRegistrationSigninWithRegistrationId:registrationId
          ...
          completionHandler: ^(TGSigninDetail* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling TGSigninsApi->createRegistrationSignin: %@", error);
                        }
                    }];
```
...
[apiInstance createRegistrationSignoutWithRegistrationId:registrationId
          ...
          completionHandler: ^(TGSigninDetail* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling TGSigninsApi->createRegistrationSignout: %@", error);
                        }
                    }];
```
