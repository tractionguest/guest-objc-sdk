...
@class TGCustomField;
@protocol TGNotificationTrigger1;
@class TGNotificationTrigger1;



@protocol TGInviteCreateParams1
@end

@interface TGInviteCreateParams1 : TGObject
...
@property(nonatomic) NSArray<TGNotificationTrigger1>* notificationTriggers;
