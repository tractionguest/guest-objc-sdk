...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"altNames", @"federalRegisterNotice", @"name", @"sourceInformationUrl", @"sourceListUrl", @"list", @"type", @"category", @"street1", @"street2", @"city", @"state", @"country", @"notes", @"frc", @"start", @"end", @"frserve", @"optionalID", @"alertType", @"pairStatus", @"pairReason", @"pairComments", @"applicationDisplayName", @"applicationId", @"clientId", @"clientKey", @"clientFullName", @"listKey", @"listName", @"listId", @"listVersion", @"listModifyDate", @"listProfileId", @"listProfileKey", @"linkSingleStringName", @"listParentSingleStringName", @"listCategory", @"listPepCategory", @"listDoBs", @"listCountries", @"rankString", @"ranktype", @"rankweight", @"pairLoadDate", @"eAddressTo", @"eAddressCc", @"origin", @"secondsviewed", @"initialUser", @"isPairParentFlag", @"pairMetSearchCriteriaFlag", @"editableDueToAssignmentFlag", @"modifyDate", @"modifiedByUser", @"pairReportType", @"finscanCategory", @"wrapperStatus", @"sourceLists", @"error"];
